...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      para("Using a series of structured prompts, I had Claude itself generate:"),
      ...
      para([
        ...
        new TextRun({ text: "That came from iterating with Claude itself.", font: "Arial", size: 22, bold: true }),
        new TextRun({ text: " It\u2019s the first time I\u2019ve genuinely felt that AI is not just a tool for work \u2014 it\u2019s a study partner.", font: "Arial", size: 22 })
      ]),
      ...
      // ── CLOSING ──────────────────────────────────────────────────
      heading("\uD83C\uDF1F  The Unofficial Claude Architect", 1),
      ...
      new Paragraph({ spacing: { before: 0, after: 240 }, children: [new TextRun({ text: "Unofficial Claude Certified Architect  |  The Hartford", font: "Arial", size: 20, color: "666666", italics: true })] }),
